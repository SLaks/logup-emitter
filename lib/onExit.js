...
var onException = function onException(err) {
	...
	// Must check length before running listeners, since
	// the array may mutate beneath us when on Node 0.8.
	var hasOtherListeners = logUpListeners.length === allListeners.length;
