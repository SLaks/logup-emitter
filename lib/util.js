...
exports.sourceLabel = function (source) {
	var shortFile = source.filename ? exports.displayName(source.filename) : "?";
	...
	if (shortFile === source.packageInfo.name + "/")
		shortFile = path.basename(source.filename);
...
// I copied this from node's util.js and will add support for Error instances.
/**
